package com.knightboot.weaver.internal.parser;

import com.google.common.base.Joiner;
import com.knightboot.weaveinterface.annotations.ClassOf;
import com.knightboot.weaveinterface.annotations.ImplementedInterface;
import com.knightboot.weaveinterface.annotations.Insert;
import com.knightboot.weaveinterface.annotations.NameRegex;
import com.knightboot.weaveinterface.annotations.Proxy;
import com.knightboot.weaveinterface.annotations.TargetClass;
import com.knightboot.weaveinterface.annotations.TryCatchHandler;
import com.knightboot.weaver.MetaParser;
import com.knightboot.weaver.internal.entity.TransformInfo;
import com.knightboot.weaver.internal.exception.LoadClassException;
import com.knightboot.weaver.internal.exception.UnsupportedAnnotationException;
import com.knightboot.weaver.internal.graph.Graph;
import com.knightboot.weaver.internal.log.Log;
import com.knightboot.weaver.internal.meta.ClassMetaInfo;
import com.knightboot.weaver.internal.meta.MethodMetaInfo;
import com.knightboot.weaver.internal.parser.anno.AcceptAny;
import com.knightboot.weaver.internal.parser.anno.ClassOfAnnoParser;
import com.knightboot.weaver.internal.parser.anno.DelegateAcceptableAnnoParser;
import com.knightboot.weaver.internal.parser.anno.GatheredAcceptableAnnoParser;
import com.knightboot.weaver.internal.parser.anno.ImplementedInterfaceAnnoParser;
import com.knightboot.weaver.internal.parser.anno.InsertAnnoParser;
import com.knightboot.weaver.internal.parser.anno.NameRegexAnnoParser;
import com.knightboot.weaver.internal.parser.anno.ProxyAnnoParser;
import com.knightboot.weaver.internal.parser.anno.TargetClassAnnoParser;
import com.knightboot.weaver.internal.parser.anno.TryCatchAnnoParser;
